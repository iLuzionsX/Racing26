...
export class Simulation {
  ...
  private interpolateState(prev: VehicleState, curr: VehicleState, alpha: number): VehicleState {
    ...
    return {
      ...
      // CarRenderer root Y uses elevationHeight (road-following base) plus heave.
      // Leaving it at curr reintroduces 120 Hz stepping on graded/banked showcase
      // geometry. This is render interpolation only; stepExplicit/physics state is untouched.
