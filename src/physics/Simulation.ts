...
export class Simulation {
  ...
  private interpolateState(prev: VehicleState, curr: VehicleState, alpha: number): VehicleState {
    ...
    return {
      ...
      // CarRenderer places the body root from elevationHeight, not raw y.
      // On showcase grades/banking elevationHeight changes every fixed step;
      // leaving it uninterpolated reintroduces a 120 Hz vertical step.
      // Render interpolation only; stepped physics state is unchanged.
